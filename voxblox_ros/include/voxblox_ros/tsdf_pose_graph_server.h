...
#include "../thirdparty/okvis/threadsafe/ThreadsafeQueue.hpp"
...
class TsdfPoseGraphServer {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  TsdfPoseGraphServer(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private);
  TsdfPoseGraphServer(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private,
             const TsdfMap::Config& config,
             const TsdfIntegratorBase::Config& integrator_config,
             const MeshIntegratorConfig& mesh_config);
  virtual ~TsdfPoseGraphServer();
